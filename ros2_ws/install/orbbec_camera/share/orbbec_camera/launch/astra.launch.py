...
def generate_launch_description():
    ...
    #========================= Color 640x480 30fps OB_FORMAT_UYVY  =============================
        DeclareLaunchArgument('color_width', default_value='640'), #640
        DeclareLaunchArgument('color_height', default_value='480'), #480
        DeclareLaunchArgument('color_fps', default_value='30'), #10
        DeclareLaunchArgument('color_format', default_value='UYVY'), #RGB 
    ...
    #================= Depth 640x480 30fps OB_FORMAT_Y11  =============================
    ...
    #====================== IR sensor 640x480 30fps OB_FORMAT_Y10 =============================
        DeclareLaunchArgument('ir_width', default_value='640'), #640x480 30fps OB_FORMAT_Y10
    ...
    #============================ Publishing =============================
        ...
        DeclareLaunchArgument('tf_publish_rate', default_value='30.0'),
