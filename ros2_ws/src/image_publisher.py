...
class ImagePublisher(Node):
  ...
  def __init__(self):
    ...
    self.publisher_ = self.create_publisher(String, '/segment_string', 10)
  ...
  def timer_callback(self, msg):
    ...
    # processed_image_msg = self.br.cv2_to_imgmsg(image, 'bgr8')
    # self.publisher_.publish(processed_image_msg)
    # # print(processed_image_msg)
    ...
    # print(type(image_as_str))
    str_msg.data = image_as_str
    # processed_image_msg = self.br.cv2_to_imgmsg(image, 'bgr8')
